    ...
    <div className="bg-gradient-to-br from-gray-900/50 to-black/50 rounded-xl overflow-hidden border border-purple-500/20 hover:border-purple-400/50 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2">
      ...
      <div className="p-6">
        ...
        <div className="flex gap-3">
          <button className="flex-1 bg-gradient-to-br from-gray-800/50 to-black/50 border border-gray-700 hover:border-purple-500/50 text-white py-2 px-4 rounded-lg transition-all duration-200 text-sm font-medium">
            View Details
          </button>
