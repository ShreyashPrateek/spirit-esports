              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-800/30 rounded-lg p-6 border border-purple-500/10">
                    ...
                    <p className="text-gray-300">+91 {userProfile.phone}</p>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <button className="w-full bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white py-3 px-4 rounded-lg transition-all duration-200 font-medium transform hover:scale-105 flex items-center justify-center space-x-2">
