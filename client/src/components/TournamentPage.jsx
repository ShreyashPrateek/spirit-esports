...
const TournamentDetailsModal = ({ tournament, isOpen, onClose }) => {
          ...
          <div className="p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              {tournament.status === 'upcoming' && (
                <button className="flex-1 bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white py-3 px-6 rounded-lg transition-all duration-200 font-medium">
                  Register Now
                </button>
              )}
    ...
    <div className="bg-gradient-to-br from-gray-900/50 to-black/50 rounded-xl overflow-hidden border border-purple-500/20 hover:border-purple-400/50 transition-all duration-300 transform hover:scale-105 hover:-translate-y-2">
      ...
      <div className="p-6">
        ...
        <div className="flex gap-3">
          ...
          {tournament.status === 'upcoming' && (
            <button className="flex-1 bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white py-2 px-4 rounded-lg transition-all duration-200 text-sm font-medium">
              Register Now
            </button>
          )}
